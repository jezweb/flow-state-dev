...
const errorPatterns = {
  ...
  // Flow State Dev specific errors
  'modules not found': {
    type: ErrorTypes.USER_INPUT,
    message: 'One or more specified modules were not found',
    solution: 'Check available modules and fix the module names:',
    commands: ['fsd modules list'],
    tips: [
      'Module names are case-sensitive',
      'Use commas to separate multiple modules: vue-base,vuetify',
      'Check for typos in module names'
    ]
  },
  'invalid stack configuration': {
    type: ErrorTypes.CONFIGURATION,
    message: 'The selected modules are incompatible',
    solution: 'Review module compatibility:',
    commands: ['fsd modules list', 'fsd modules info <module-name>'],
    tips: [
      'Some modules conflict with each other (e.g., vue-base and react-base)',
      'Check module requirements and compatibility',
      'Try selecting compatible modules'
    ]
  },
  'project directory already exists': {
    type: ErrorTypes.FILE_SYSTEM,
    message: 'Target directory already exists and is not empty',
    solution: 'Choose a different project name or clean the directory:',
    commands: [
      'fsd init my-new-project-name --modules vue-base',
      'rm -rf existing-project  # Remove existing directory'
    ],
    alternative: 'Or use --force to overwrite (dangerous):',
    alternativeCommands: ['fsd init existing-project --modules vue-base --force'],
    tips: [
      'Use --force flag with caution as it overwrites existing files',
      'Consider backing up existing files first'
    ]
  },
  'module directory not found': {
    type: ErrorTypes.FILE_SYSTEM,
    message: 'Module directory structure is missing or corrupted',
    solution: 'Reinstall Flow State Dev or check installation:',
    commands: [
      'npm uninstall -g flow-state-dev',
      'npm install -g flow-state-dev'
    ],
    alternative: 'Or use npx for latest version:',
    alternativeCommands: ['npx flow-state-dev init my-project --modules vue-base']
  },
  'template generation failed': {
    type: ErrorTypes.FILE_SYSTEM,
    message: 'Failed to generate project files from templates',
    solution: 'Check file permissions and try again:',
    commands: [
      'ls -la .',
      'chmod +w .',
      'fsd init my-project --modules vue-base --verbose'
    ],
    tips: [
