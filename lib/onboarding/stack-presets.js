...
export class StackPresetManager {
  ...
  initializeDefaultPresets() {
    ...
    this.addPreset({
      ...
      modules: ['base-config', 'vue-base', 'vuetify', 'supabase', 'vercel'],
      recommended: true,
    ...
    // SvelteKit Full Stack with Better Auth
    this.addPreset({
      id: 'sveltekit-full-stack',
      name: 'SvelteKit Full Stack',
      description: 'SvelteKit + Better Auth + Tailwind + Vercel - Complete modern web app',
      modules: ['sveltekit', 'better-auth', 'tailwind', 'vercel'],
      tags: ['frontend', 'backend', 'auth', 'deployment'],
      useCase: 'Full-stack applications with modern authentication and deployment',
      difficulty: 'intermediate'
    });
    ...
    this.addPreset({
      ...
      description: 'SvelteKit + Tailwind + Vercel - Modern frontend with deployment',
      modules: ['sveltekit', 'tailwind', 'vercel'],
      tags: ['frontend', 'ui', 'deployment'],
      useCase: 'Fast, modern web applications with SSR/SSG and deployment',
      difficulty: 'intermediate'
    });
    ...
    this.addPreset({
      ...
      description: 'SvelteKit + Supabase + Tailwind + Vercel - Full stack with BaaS',
      modules: ['sveltekit', 'supabase', 'tailwind', 'vercel'],
      tags: ['frontend', 'backend', 'database', 'auth', 'deployment'],
      useCase: 'Full-stack applications with Supabase backend and deployment',
      difficulty: 'intermediate'
    });

    // SvelteKit Minimal
    this.addPreset({
      id: 'sveltekit-minimal',
      name: 'SvelteKit Minimal',
      description: 'SvelteKit only - Fast, lightweight setup for Svelte apps',
      modules: ['sveltekit'],
      tags: ['frontend', 'minimal'],
      useCase: 'Simple SvelteKit applications, learning projects',
      difficulty: 'beginner'
    });
  }
