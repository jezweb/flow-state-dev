...
export class StackPresetManager {
  ...
  initializeDefaultPresets() {
    ...
    this.addPreset({
      id: 'vue-full-stack',
      name: 'Vue Full Stack',
      description: 'Vue 3 + Vuetify + Supabase - Perfect for rapid prototyping',
      modules: ['vue-base', 'vuetify', 'supabase'],
      recommended: true,
      tags: ['frontend', 'backend', 'database', 'auth'],
      useCase: 'Full-featured web applications with modern UI and backend',
      difficulty: 'beginner'
    });
    ...
    this.addPreset({
      id: 'vue-frontend',
      name: 'Vue Frontend',
      description: 'Vue 3 + Vuetify - For frontend-only projects or when you have existing backend',
      modules: ['vue-base', 'vuetify'],
      tags: ['frontend', 'ui'],
      useCase: 'Frontend applications, admin dashboards, SPAs',
      difficulty: 'beginner'
    });
    ...
    this.addPreset({
      ...
      description: 'React + Tailwind + Supabase - Modern React stack with utility-first CSS',
      modules: ['react', 'tailwind', 'supabase'],
      tags: ['frontend', 'backend', 'database', 'auth'],
      useCase: 'React applications with modern styling and backend',
    ...
    this.addPreset({
      id: 'react-frontend',
      name: 'React Frontend',
      description: 'React + Tailwind - Clean and modern React setup',
      modules: ['react', 'tailwind'],
      tags: ['frontend', 'ui'],
      useCase: 'React SPAs, component libraries, frontend applications',
      difficulty: 'intermediate'
    });
