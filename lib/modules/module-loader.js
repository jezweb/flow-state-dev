...
export class ModuleLoader {
  ...
  async load(modulePath) {
    ...
    try {
      ...
      // Resolve templatePath if it's relative
      if (moduleInstance.templatePath && !isAbsolute(moduleInstance.templatePath)) {
        moduleInstance.templatePath = join(modulePath, moduleInstance.templatePath);
      }
